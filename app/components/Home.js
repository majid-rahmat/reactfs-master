      ...
      <div className="ui container">
        <div className="ui grid">
          ...
          <div className="six wide column">
            <Image customClass='ui large image img' src='/app/public/images/4elements.jpg' /> 
          </div>
            
          <div className='ten wide column'>
                            
              <Text customClass='column medium txt1' msg='This site strives to be a primary point of interaction between you and the rap world. It is a digital haven and sanctuary for all — from the battle-hardened hip hop head to the soon-to-be-Stan— and is a platform for YOUR active participation and engagement in showcasing the world, its wonders, and its people to its people!
              ...
              <div className='ui two column grid'>
                ...
                <div className="column">
                  <div className="middle aligned content">
                    <Text customClass='medium txt2' msg='Press play for a look at pop culture through marketing, branding and business strategy (or is it the other way round?!)
